...
routes.post("/students/mobile-authenticate/:id", SessionController.mobileAuthenticate);
...
routes.get("/students/:id/help-orders/:idHelpOrder", HelpOrdersController.indexHelpOrdersByIdAndStudentsById);
