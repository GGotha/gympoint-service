...
protectedRoutes.post("/help-orders/:id/answer", HelpOrdersController.answerStudents);
protectedRoutes.get("/help-orders", HelpOrdersController.indexUnanswered);
protectedRoutes.get("/help-orders/:id", HelpOrdersController.indexHelpOrdersById);
